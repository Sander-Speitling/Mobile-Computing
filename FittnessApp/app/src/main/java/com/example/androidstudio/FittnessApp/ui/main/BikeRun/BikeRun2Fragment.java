...
public class BikeRun2Fragment extends Fragment implements View.OnClickListener, LocationListener {
    private static final String TAG = "BikeRun2Fragment";
    ...
    private Button bikeRun1Button;
    private Button bikeRun3Button;
    //Overlays
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        OnBackPressedCallback callback = new OnBackPressedCallback(true) {
            ...
            public void handleOnBackPressed() {
                ...
                backAlert.setTitle("Zurück zu BikeRun1");
                ...
                backAlert.setPositiveButton("Ja", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        Log.v(TAG, "going back to BikeRun1");
                        NavHostFragment.findNavController(getParentFragment()).navigate(R.id.action_bikeRun2Fragment_to_bikeRunFragment);
                    }
                });
        ...
        bikeRun1Button = (Button) view.findViewById(R.id.bikeRun1);
        bikeRun3Button = (Button) view.findViewById(R.id.bikeRun3);
        ...
        bikeRun1Button.setOnClickListener(this);
        bikeRun3Button.setOnClickListener(this);
            ...
            case R.id.gpsButton:
                ...
                if ( ! startStopGPS) {
                    ...
                    if (ActivityCompat.checkSelfPermission(getActivity(), Manifest.permission.ACCESS_FINE_LOCATION) == PackageManager.PERMISSION_GRANTED) {
                        locationManager.requestLocationUpdates(LocationManager.GPS_PROVIDER, 0, 0, com.example.androidstudio.FittnessApp.ui.main.BikeRun.BikeRun2Fragment.this);
                    }
                ...
                break;
            case R.id.bikeRun1:
                Log.d(TAG,"onClick BikeRun1");
                AlertDialog.Builder bike1Alert = new AlertDialog.Builder(getActivity());
                bike1Alert.setTitle("Zurück zu BikeRun1");
                bike1Alert.setMessage("Soll das Tracking wirklich gestoppt werden?");
                bike1Alert.setPositiveButton("Ja", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {
                        Log.v(TAG, "going back to BikeRun1");
                        NavHostFragment.findNavController(getParentFragment()).navigate(R.id.action_bikeRun2Fragment_to_bikeRunFragment);
                ...
                bike1Alert.setNeutralButton("Abbrechen", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {
                        //do nothing
                    }
                ...
                break;
            case R.id.bikeRun3:
                Log.d(TAG,"onClick BikeRun3");
                AlertDialog.Builder bike3Alert = new AlertDialog.Builder(getActivity());
                bike3Alert.setTitle("Weiter zu BikeRun3");
                bike3Alert.setMessage("Soll das Tracking wirklich gestoppt werden?");
                bike3Alert.setPositiveButton("Ja", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {
                        Log.v(TAG, "going to BikeRun3");
                        NavHostFragment.findNavController(getParentFragment()).navigate(R.id.action_bikeRun2Fragment_to_bikeRun3Fragment);
                    }
                });

                bike3Alert.setNeutralButton("Abbrechen", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {
                        //do nothing
                    }
